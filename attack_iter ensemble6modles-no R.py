...
def graph(x, mask, y, i, x_max, x_min, grad):
    ...
    logits = (logits_v3 + logits_v4 + logits_res_v2 + logits_resnet
               + logits_ens3_adv_v3 + logits_ens4_adv_v3 ) / 6

    auxlogits = (end_points_v3['AuxLogits'] + end_points_v4['AuxLogits'] + end_points_res_v2['AuxLogits']
                  + end_points_ens3_adv_v3['AuxLogits'] + end_points_ens4_adv_v3['AuxLogits']
                 ) / 5
