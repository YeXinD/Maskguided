...
tf.flags.DEFINE_string(
    'dev_path', ' ', 'Input directory with images.')
...
def graph(x, mask, y, i, x_max, x_min, grad):
    ...
    logits = ( logits_v4 + logits_res_v2 + logits_resnet
              +  logits_v4_rotated + logits_res_v2_rotated + logits_resnet_rotated
              + logits_ens3_adv_v3 + logits_ens4_adv_v3 + logits_ens_advres_v2
    ...
    auxlogits = (
                # end_points_v3['AuxLogits'] 
                 ...
                 + end_points_ens_advres_v2['AuxLogits'] ) / 5
